...
let cinderellas = [
    new Cinderella("Ivanna", 25, 21),
    new Cinderella("Маша", 26, 25),
    new Cinderella("Галя", 22, 32),
    new Cinderella("Петя", 21, 35),
    new Cinderella("Ирина", 29, 34),
    new Cinderella("Дарона", 35, 33),
    new Cinderella("Антонина", 33, 30),
    new Cinderella("Гермиона", 35, 28),
    new Cinderella("Валентина", 45, 39),
    new Cinderella("Ната", 37, 37)
];
...
let prince = new Prince('Valera', 25, 33)

let cinder = cinderellas.find(value => value.footSize === prince.shoeSize)
console.log(cinder)